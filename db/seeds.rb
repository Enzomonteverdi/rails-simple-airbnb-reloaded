...
Flat.create!(
  name: 'Picadilly Circus Beauty',
  address: 'Picadilly Rd London N1C 4QP',
  description: 'A big loft with grat view to the most famous circle in London. Fully equiped Kitchen.',
  price_per_night: 200,
  number_of_guests: 4
)
